...
module.exports = function({chargersRouter, transactionRouter, transactionsRouter, authenticationRouter, adminRouter, chargePointsRouter, invoicesRouter, ocppInterface, testRouter }) { //authenticationRouter
