...
module.exports = function ({}) {
  ...
  exports.getAddChargerValidation = function (
    location,
    serialNumber,
    chargePointID
  ) {
  ...
  exports.getChargerBySerialNumberValidation = function (serialNumber) {
    return [...getSerialNumberValidationErrors(serialNumber)];
  };
...
function getSerialNumberValidationErrors(serialNumber) {
  ...
  if (serialNumber === undefined || serialNumber === null) {
    ...
    if (
      serialNumber.length < SERIAL_NUMBER_MIN_VALUE ||
      serialNumber.length > SERIAL_NUMBER_MAX_VALUE
    ) {
      validationErrors.push("invalidSerialNumber");
    }
  }
