...
module.exports = function ({ chargerMessageHandler, c, broker, databaseInterfaceTransactions, databaseInterfaceCharger }) {
  ...
  exports.testHandleStopTransactions = function () {
    const chargerID = "charger123";
  ...
  exports.testHandleStartTransaction = function () {
  ...
  exports.testHandleDataTransfer = function () {
  ...
  exports.testUpdateChargerLevel = function() {
    describe('updateChargerLevel', () => {
  ...
  exports.testSendBootNotificationResponse = function () {
    describe('sendBootNotificationRepsonse', () => {
  ...
  exports.testSendBootData = function () {
    describe('sendBootData', () => {
      const chargerID = 'charger123';
  ...
  exports.testGetChargingPrice = function () {
    describe('getChargingPrice', () => {
      const chargerID = 'charger123';
  ...
  exports.testSendStatusNotificationResponse = function () {
    describe('sendStatusNotificationResponse', () => {
      const chargerID = 'charger123';
      const uniqueID = 'unique123';
