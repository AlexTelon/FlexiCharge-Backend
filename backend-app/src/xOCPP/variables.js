...
module.exports = function ({ }) {
    ...
    exports.getconnectorID = function (serial) {
        return connectorIDs[serial]
    }
    exports.addconnectorIDs = function (serial, id) {
        connectorIDs[serial] = id
    }
    exports.removeconnectorIDs = function (serial) {
        delete connectorIDs[serial]
    }
    exports.getLengthconnectorIDs = function () {
        return Object.keys(connectorIDs).length
    }
    ...
    //TRANSACTIONIDS
    //get transactionID with connectorID
    exports.getTransactionID = function (connectorID) {
        return transactionIDs[connectorID]
    }
    exports.addTransactionID = function (connectorID, transactionID) {
        transactionIDs[connectorID] = transactionID
    }
    exports.removeTransactionID = function (connectorID) {
        delete transactionIDs[connectorID]
    }
